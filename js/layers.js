...
hotkeys: [
    ...
    addLayer("i", {
        ...
        upgrades: {
               ...
               12: {
                title: "faster, yet faster",
                description: "Multiply your Golden Coin gain by 100. (note: this applies FIRST.)",
                cost: new Decimal(5),
           },
            },
} )
addLayer("h", {
    ...
    color: "#4BDC13",                       // The color for this layer, which affects many elements.
    resource: "Houses",            // The name of this layer's main prestige resource.
    row: 3,                                 // The row this layer is on (0 is the first row).

    baseResource: "points",                 // The name of the resource your prestige gain is based on.
    baseAmount() { return player.points },  // A function to return the current amount of baseResource.

    requires: new Decimal(1500000),              // The amount of the base needed to  gain 1 of the prestige currency.
                                            // Also the amount required to unlock the layer.
